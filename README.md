...
PPaste 是一个面向 macOS 的本地剪贴板工具。
它常驻菜单栏，记录文本与图片剪贴板历史，并支持用全局快捷键快速唤起，再将选中的内容直接粘贴回当前输入位置。
...
1. 启动 PPaste
2. 在系统设置中允许 PPaste 访问辅助功能
3. 如果要正常读取剪贴板历史，允许 PPaste 在前台读取剪贴板
4. 打开设置页，确认唤起快捷键

如果没有辅助功能权限，PPaste 可以显示历史，但无法把选中内容自动粘贴回当前输入框。
...
也可以直接选择“双击 Command”作为显示/隐藏窗口快捷键。
